...
#Perl script to count sRNA sequences of 20 to 26 nts in length from a fasta file and to calculate 
#the percentage of each sRNA size class comparing to the total number of sequences analyzed. 
